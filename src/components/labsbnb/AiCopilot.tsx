    ...
    <>
      {!open && (
        <button
          ...
          className="group fixed bottom-5 right-4 z-40 flex items-center gap-2 rounded-full border border-primary/40 bg-background/80 px-4 py-3 backdrop-blur transition-transform duration-200 hover:scale-[1.04] active:scale-95"
          style={{
